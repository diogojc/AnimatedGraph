...
CanvasController.prototype.pan=function(e,absoluteorig,inittrans){
	...
	this.view.translation = inittrans.add(relativedest.minus(relativeorig).product(this.view.scale));
};
//Callback to end pan
...
CanvasController.prototype.mousescroll=function(e){
	...
	if(!direction)
		return;
	if(direction=='up'){
		//Center view half way between view center and mouse position (insipired in google maps :D)
		;
		//Zoom in
