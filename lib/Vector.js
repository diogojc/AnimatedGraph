...
Vector.prototype.dotProduct=Vector.prototype.dot=Vector.prototype.innerProduct=function(v){
	return (this.x*v.x)+(this.y*v.y)+(this.z*v.z);
};

Vector.prototype.crossProduct=Vector.prototype.cross=Vector.prototype.outerProduct=function(v){

};

Vector.prototype.power=function(e){
	return Math.pow(this.x,e)+Math.pow(this.y,e)+Math.pow(this.z,e);
};
